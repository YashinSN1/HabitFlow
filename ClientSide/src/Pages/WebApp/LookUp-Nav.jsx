    ...
    return (
        <>
            <div className=" border-b bg-white flex py-1.5 itmes-center justify-end h-full gap-4 px-5 w-full">
                ...
                <div className="rounded-xl px-4 w-full max-w-fit h-full md:flex hidden justify-center items-center border-2 transition-colors hover:border-red-500 border-red-100">
